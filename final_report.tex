...
Our R codes for 5-fold cross validation are in ``Section D: Cross Validation'' of the supplementary file ``final-project.R''.
...
Our R codes used to compute error rates are in ``Section C: Utility Functions'' of the supplementary file ``final-project.R''.
...
Our R codes for benchmark are in ``Section E: Benchmark'' of the supplementary file ``final-project.R''.
...
Our R codes for linear regression are in ``Section F: Linear Model'' of the supplementary file ``final-project.R''.
...
Our R codes for linear regression with backward elimination are in ``Section G: Variable Selection-Backward Elimination'' of the supplementary file ``final-project.R''.
...
Our R codes for linear regression with AIC are in ``Section H: Variable Selection-AIC'' of the supplementary file ``final-project.R''.
...
Our R codes for random forest are in ``Section I: Random Forest'' of the supplementary file ``final-project.R''.
...
Our R codes for gradient boosting are in ``Section J: Gradient Boosting'' of the supplementary file ``final-project.R''.
...
To untar this tar file, please run the following command: ``tar xvfz somefilename.tar.gz''.
...
Aiello, Spencer. ``Package ‘h2o'.'' Cran R-project. CRAN, 15 Mar. 2016. Web. 5 May 2016. <https://cran.r-project.org/web/packages/h2o/h2o.pdf>.

Chen, Tianqi. ``Package ‘xgboost'.'' Cran R-project. CRAN, 15 Feb. 2016. Web. 5 May 2016. <https://cran.r-project.org/web/packages/xgboost/xgboost.pdf>.

Chen, Tianqi. ”Introduction to Boosted Trees.” (2014): n. pag. <https://homes.cs.washington.edu/~tqchen/data/pdf/BoostedTree.pdf>. University of Washington, 22 Oct 2014. Web. 5 May 2016.

Gu, Jay (Haijie). ``Using Gradient Boosted Trees to Predict Bike Sharing Demand.'' Dato. 19 Aug. 2014. Web. 5 May 2016.

``Rossmann Store Sales.'' Rossmann Store Sales. Kaggle, 30 Sept. 2015. Web. 5 May 2016. <https://www.kaggle.com/c/rossmann-store-sales>.
