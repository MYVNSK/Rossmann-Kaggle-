...
Reduced Model (Forward-Backward Elimination)
 

For linear model with all features (full model), the error rate was 0.09101 on a validation set and 0.21036 on the test set.

For linear model with backward elimination (reduced model), the error rate was 0.09108 on a validation set and 0.20988 on the test set.

For linear model with AIC (reduced model), the error rate was 0.091006 on a validation set and 0.21039 on the test set.
